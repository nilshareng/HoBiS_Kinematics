...
for iii = 1:size(FileSelect1,2)
    ...
    save(strcat('C:\Users\nhareng\Desktop\CodeCommente\hobis\Resultats\Txt\Batch15','\', ...
    FileNames{iii},num2str(MaxLoop),'-PasModifs-', num2str(PasModifs),'-PasDelta-', num2str(PasDelta),'-NoFMS--50-NoSecCost','.mat'),'Results');
end
