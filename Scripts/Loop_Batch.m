...
%     end
    ...
    if derflag 
        DRef=[];
        [a,b] = ErrorFun(NPolA,X,Param); % ErrorFun pour le gradient
        ...
        a = ErrorFun2(NPolA,X,Param, R_monde_local,R_Pelvis_monde_local, R_LFem_ref_local, R_LTib_ref_local, R_RFem_ref_local, R_RTib_ref_local); % ErrorFun2 sinon
    ...
    [P, TA] = Sampling(NPolA, Period,Fem1g, Fem1d, Fem6g, Fem6d, Tal1g, Tal1d, R_monde_local,R_Pelvis_monde_local, R_LFem_ref_local, R_LTib_ref_local, R_RFem_ref_local, R_RTib_ref_local);
    ...
    if (printflag)
        ...
        for i = 1:6
            ...
            plot(0:1/Period:1,Spline(:,i),'g--');
            plot(0:1/Period:1,GT(:,i),'r');
...
%             Modifs = Jkp*delta + Proj*(DJerk/norm(DJerk))*JSter;
