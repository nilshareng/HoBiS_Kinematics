...
if size(fieldnames(markers),1)==12
    ...
    plot3(markers.RFWT(1), markers.RFWT(2), markers.RFWT(3),'kx');
    plot3(markers.LFWT(1), markers.LFWT(2), markers.LFWT(3),'kx');
    ...
    plot3(markers.RTib6(1),markers.RTib6(2),markers.RTib6(3),'kx');
    plot3(markers.LTib6(1),markers.LTib6(2),markers.LTib6(3),'kx');
    plot3(markers.RTib1(1),markers.RTib1(2),markers.RTib1(3),'kx');
    plot3(markers.LTib1(1),markers.LTib1(2),markers.LTib1(3),'kx');
    plot3(markers.RTal1(1),markers.RTal1(2),markers.RTal1(3),'kx');
    plot3(markers.LTal1(1),markers.LTal1(2),markers.LTal1(3),'kx');
